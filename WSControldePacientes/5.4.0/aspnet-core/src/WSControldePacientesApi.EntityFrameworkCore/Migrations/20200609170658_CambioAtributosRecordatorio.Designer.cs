...
namespace WSControldePacientesApi.Migrations
{
    ...
    [Migration("20200609170658_CambioAtributosRecordatorio")]
    partial class CambioAtributosRecordatorio
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.Citas.Cita", b =>
                {
                    ...
                    b.Property<string>("Servicio_Especialidad")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.ControlTemperaturas.ControlTemperatura", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ControlTemperatura");
                });

            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.Direcciones.Direccion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.EnfermadesPacientes.EnfermedadPaciente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.Medicamentos.Medicamento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ComponenteBase")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.Medicos.Medico", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<long>("DatosPersonalesId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.Mensajes.Mensaje", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<long>("PersonaDestinoId")
                        .HasColumnType("bigint");

                    b.Property<long>("PersonaOrigenId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PersonaDestinoId");

                    b.HasIndex("PersonaOrigenId");

                    b.ToTable("mensajes");
                });

            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.Pacientes.Paciente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("MiMedicoCabeceraId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.PacientesResponsables.PacienteResponsable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.Responsables.Responsable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("WSControldePacientesApi.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("WSControldePacientesApi.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.Citas.Cita", b =>
                {
                    b.HasOne("WSControldePacientesApi.ControlPacientes.Direcciones.Direccion", "Direccion")
                        .WithMany("citas")
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.EnfermadesPacientes.EnfermedadPaciente", b =>
                {
                    b.HasOne("WSControldePacientesApi.ControlPacientes.Enfermedades.Enfermedad", "Enfermedad")
                        .WithMany("enfermedadPacientes")
                        .HasForeignKey("EnfermedadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WSControldePacientesApi.ControlPacientes.Pacientes.Paciente", "Paciente")
                        .WithMany("MisEnfermedades")
                        .HasForeignKey("PacienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.Medicos.Medico", b =>
                {
                    b.HasOne("WSControldePacientesApi.Authorization.Users.User", "DatosPersonales")
                        .WithOne()
                        .HasForeignKey("WSControldePacientesApi.ControlPacientes.Medicos.Medico", "DatosPersonalesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.Mensajes.Mensaje", b =>
                {
                    b.HasOne("WSControldePacientesApi.Authorization.Users.User", "PersonaDestino")
                        .WithMany("MensajesRecibidos")
                        .HasForeignKey("PersonaDestinoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WSControldePacientesApi.Authorization.Users.User", "PersonaOrigen")
                        .WithMany("MensajesEnviados")
                        .HasForeignKey("PersonaOrigenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.Pacientes.Paciente", b =>
                {
                    b.HasOne("WSControldePacientesApi.Authorization.Users.User", "DatosPersonales")
                        .WithOne()
                        .HasForeignKey("WSControldePacientesApi.ControlPacientes.Pacientes.Paciente", "DatosPersonalesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WSControldePacientesApi.ControlPacientes.Direcciones.Direccion", "DondeVive")
                        .WithMany("pacientes")
                        .HasForeignKey("DondeViveId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.PacientesResponsables.PacienteResponsable", b =>
                {
                    b.HasOne("WSControldePacientesApi.ControlPacientes.Pacientes.Paciente", "Paciente")
                        .WithMany("MisResponsables")
                        .HasForeignKey("PacienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WSControldePacientesApi.ControlPacientes.Responsables.Responsable", "Responsable")
                        .WithMany("MisPacientes")
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.Prescripciones.Prescripcion", b =>
                {
                    b.HasOne("WSControldePacientesApi.ControlPacientes.Medicamentos.Medicamento", "Medicamento")
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.Recordatorios.Recordatorio", b =>
                {
                    ...
                    b.HasOne("WSControldePacientesApi.ControlPacientes.Prescripciones.Prescripcion", null)
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.Responsables.Responsable", b =>
                {
                    b.HasOne("WSControldePacientesApi.Authorization.Users.User", "DatosPersonales")
                        .WithOne()
                        .HasForeignKey("WSControldePacientesApi.ControlPacientes.Responsables.Responsable", "DatosPersonalesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
