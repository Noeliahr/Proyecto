...
namespace WSControldePacientesApi.Migrations
{
    ...
    [Migration("20200517185320_AddRelaciones1")]
    partial class AddRelaciones1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.TemperaturasPacientes.TemperaturaPaciente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WSControldePacientesApi.ControlPacientes.TemperaturasPacientes.TemperaturaPaciente", b =>
                {
                    b.HasOne("WSControldePacientesApi.ControlPacientes.Pacientes.Paciente", "Paciente")
                        .WithMany("Control_de_Temperatura")
                        .HasForeignKey("PacienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
