...
using Shouldly;
using Xunit;
using WSControldePacientesApi.Sessions;

namespace WSControldePacientesApi.Tests.Sessions
{
    public class SessionAppService_Tests : WSControldePacientesApiTestBase
    {
