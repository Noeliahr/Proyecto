...
namespace WSControldePacientesApi.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly WSControldePacientesApiDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = WSControldePacientesApiConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(WSControldePacientesApiDbContext context)
        {
            _context = context;
        }
